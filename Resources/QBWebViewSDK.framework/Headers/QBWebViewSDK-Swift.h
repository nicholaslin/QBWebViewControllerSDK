...
SWIFT_CLASS("_TtC12QBWebViewSDK19QBWebViewController")
@interface QBWebViewController : UIViewController <WKNavigationDelegate, WKScriptMessageHandler>
...
@interface UINavigationController (SWIFT_EXTENSION(QBWebViewSDK)) <UINavigationBarDelegate>
